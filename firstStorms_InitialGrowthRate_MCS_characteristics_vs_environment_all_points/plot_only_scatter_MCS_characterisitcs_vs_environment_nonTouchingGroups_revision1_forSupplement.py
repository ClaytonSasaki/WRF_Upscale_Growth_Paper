...
Plots distributions of mean/median environmental characteristics at first storms time for all MCS and those seperated by growth rate (uses non-touching, more extreme growth subsets)
...
var_plot_str = 'LFC' #q_850, q_flux_850_v, srh_0_1km, srh_0_3km, srh_0_1km_noLatCorrection, srh_0_3km_noLatCorrection, MUCAPE, MUCIN, LCL, LFC, bulk_shear_0_3km_0, bulk_shear_0_6km_0, bulk_shear_2_6km, MLCAPE_100mb, MLCIN_100mb, rh_700, lapse_rate_3_8km, theta_e_diff_500_3000m

var_label = 'LFC - LCL (m)' # '850mb q (g/kg)', srh_0_1km (m2/ms2), srh_0_3km (m2/ms2), 'bulk 1-6 km shear (kts)', 'MUCAPE (J/kg)', '3-8 km shear (kts)', 'theta_e_diff_500_3000m'

# Note: to do LFC-LCL, 1) var_plot_str = 'LFC', 2) var_label = 'LFC - LCL (m)', 3) add -LCL to filetype_label, and 4) uncomment lines labeled 'For LFC-LCL'
...
nonTouching_seperation = np.std(var_seperation)*0.5
nonTouching_label = 'nonTouchingGroups_0.5std'

# create masked array based on MCS css area growth rate

rapid_growth = var_seperation >= seperation_threshold + nonTouching_seperation
...
slow_growth = var_seperation < seperation_threshold - nonTouching_seperation
...
print('MCS growth rate >= %.0f km^2/hr, n = %d' %(seperation_threshold + nonTouching_seperation, num_MCS_rapid_growth))
print('MCS growth rate < %.0f km^2/hr, n = %d' %(seperation_threshold - nonTouching_seperation, num_MCS_slow_growth))
...
plt.savefig(general_path + specific_outpath + '%s%s%s_wValueLabels.png' %(nonTouching_label, filetype_label, flags), dpi=200)
