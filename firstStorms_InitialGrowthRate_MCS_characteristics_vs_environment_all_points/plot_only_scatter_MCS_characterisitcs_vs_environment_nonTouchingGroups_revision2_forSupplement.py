...
var_plot_str = 'theta_e_diff_500_3000m' #q_850, q_flux_850_v, srh_0_1km, srh_0_3km, srh_0_1km_noLatCorrection, srh_0_3km_noLatCorrection, MUCAPE, MUCIN, LCL, LFC, bulk_shear_0_3km_0, bulk_shear_0_6km_0, bulk_shear_2_6km, MLCAPE_100mb, MLCIN_100mb, rh_700, lapse_rate_3_8km, theta_e_diff_500_3000m

var_label = r'$\Delta\theta_{e}$ 500-3000m (K)' # '850mb q (g/kg)', srh_0_1km (m2/ms2), srh_0_3km (m2/ms2), 'bulk 1-6 km shear (kts)', 'MUCAPE (J/kg)', '3-8 km shear (kts)', 'theta_e_diff_500_3000m'
...
plt.savefig(general_path + specific_outpath + '%s%s%s_wValueLabels_revision2.png' %(nonTouching_label, filetype_label, flags), dpi=200)
