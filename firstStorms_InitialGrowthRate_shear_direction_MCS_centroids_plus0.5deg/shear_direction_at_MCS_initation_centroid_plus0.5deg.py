...
and calculates environmental characteristics (like vertical wind shear) *only* at *first storms centroids*.
...
print('median', np.nanmedian(MCS_ccs_area_growth_filtered/MCS_growth_stage_time_length_filtered))VMRS: ', SALLJ_time_list_arr_dt)
